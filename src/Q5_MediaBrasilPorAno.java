...
public class Q5_MediaBrasilPorAno {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job j = new Job(c, "q5-media-brasil-por-ano");
        j.setJarByClass(Q5_MediaBrasilPorAno.class);
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, SumCountWritable> {
        public void map(LongWritable key, Text value, Context con)
            ...
            if (pais.equals("Brazil") && !ano.isEmpty() && !precoStr.isEmpty()) {
                try {
